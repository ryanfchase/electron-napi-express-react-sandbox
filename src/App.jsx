...
function App() {
  ...
  const content = {
    headerText: "Wifi Tool",
    fakeWifiName: "ORI-123",
  }
  ...
  return (
    <div id="inner-container">
      ...
      <div id="wifi-tool-body">
        <WifiSvg scale={0.25}/>
        <h2>{content.fakeWifiName}</h2>
        ...
        <p/>
        <button className="celestron-unselected celestron-background-gradient" onClick={handleGetInfo}>Get System Info</button>
        <p>Server Response:</p>
        <pre>
          {response}
        </pre>
